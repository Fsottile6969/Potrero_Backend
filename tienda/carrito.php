					...
					<ul class="navbar-nav">
						...
						<?php
							if($sesion == null || $sesion = ''){
								echo '<script>alert("Debe iniciar sesion para poder ingresar a este archivo");</script>';
		...
		<div class="container-fluid">
			<div class="row d-flex justify-content-center" style="height: 65vh">
				<div class="col-md-12 d-flex flex-column justify-content-center p-1 align-items-center">
					<img src="../tienda/img/construccion.png" alt="" class="bg-warning p-3 border rounded-3 h-75">
					<a class="btn btn-primary text-capitalize text-white mt-4" href="catalogo.php">regresar</a>
				</div>
			</div>
		</div>
